...
<<<<<<< HEAD
	...
	"""
    Sara chiamata ad inizio simulazione
    """
...
=======
        ...
        def __init__(self, traffic, initialWeights):
                ...
                self.lastSeenTraffic = None
                self.t0 = -1.0
                ## cherrypy.log("Ciao, sono Loris ma anche Carlo.")
